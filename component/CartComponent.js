                        ...
                        <div className = "row">
                            <center><label> <strong>Price:</strong>{ this.state.crops.price } </label></center>
                             ...
                             <div className="row">
                                ...
                                <br></br>
                             <center><button className="btn btn-success"style={{width:"30px"}}onClick={this.IncrementCropItem}>+</button>
                              <button className="btn btn-danger"style={{width:"30px"}}onClick={this.DecreaseCropItem}>-</button></center>
